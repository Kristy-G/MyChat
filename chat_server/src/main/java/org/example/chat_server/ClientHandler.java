...
import org.example.chat.common.ChatMessage;
...
//                }
    ...
    private void authenticate() {
        System.out.println("Started client  ru.geekbrains.chat_server.auth...");
        ...
        try {
            while (true) {
                ...
                if (username == null) {
                    ...
                    response.setMessageType(MessageType.ERROR);
                    response.setBody("Double ru.geekbrains.chat_server.auth!");
                    System.out.println("Double ru.geekbrains.chat_server.auth!");
                } else {
